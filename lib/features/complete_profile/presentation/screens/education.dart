        ...
        body: SafeArea(
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  MyAppBar(title: 'Education', widget: CompleteProfile(),),
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          label('University*'),
                          BasicTextField(controller: universityController),
                          label('Title'),
                          BasicTextField(controller: degreeController),
                          label('Start Year'),
                          BasicTextField(
                          ...
                          BasicTextField(
                            ...
                            onTap: () {
                              _selectDate(
                                  context, selectedEndDate, endDateController);
                            },
                          ),
                          SizedBox(
                            height: 24.h,
                            ...
                            onTap: () {
                              setState(() {
                                ...
                                universityWidget.add(UniversityContainer(
                                  ...
                                  endDate:
                                      endDateController.text.split(' ').last,
                                ));
                              });
                            },
                          )
                  ...
                  //           );
                  //         }),
                  //         itemCount: universityWidget.length))
                ],
              ),
            ),
          ),
