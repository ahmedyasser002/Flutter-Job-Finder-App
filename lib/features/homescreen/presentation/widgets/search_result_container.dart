...
class SearchResultContainer extends StatelessWidget {
  ...
  SuggestedJobModel searchJobModel;

  SearchResultContainer({super.key, required this.searchJobModel});

  @override
  Widget build(BuildContext context) {
    var myCubit = context.read<SavedCubit>();
    return BlocBuilder<SavedCubit, SavedState>(builder: (context, state) {
      if (state is AddSavedLoading||state is GetSavedLoading) {
          ...
          children: [
            Row(
              ...
              children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${searchJobModel.compName} • ${searchJobModel.location!.split(',').last.trim()} ',
                            style:
                ...
                myCubit.isSaved(searchJobModel.jobID!)
                    ? SvgPicture.asset('${svgUrl}active-bookmark.svg')
                    : InkWell(
                        onTap: () {
                          myCubit.addFavourite(id: searchJobModel.jobID!);
                        },
                        child: SvgPicture.asset('${svgUrl}black_archive.svg'))
              ],
            ),
            Padding(
              ...
              child: Row(
                ...
                children: [
                  JobTypeContainer(
                    jobType: '${searchJobModel.jobTimeType}',
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: '\$${searchJobModel.salary}',
                          style: AppTextStyle.textLMedium(AppColors.success700),
                        ),
                        TextSpan(
                            text: '/Month',
                            style: TextStyle(
